...
#ifndef __IBEX_QIBEX_ROUND_ROBIN_H__
#define __IBEX_QIBEX_ROUND_ROBIN_H__
 ...
 *
 */
class QibexRoundRobin : public Bsc {
public:
	/**
	 ...
	 */
	QibexRoundRobin(double prec, double ratio=Bsc::default_ratio());
	 ...
	 *                           bisected interval. Default value is 0.45.
	 */
	QibexRoundRobin(const Vector& prec, double ratio=Bsc::default_ratio());
...
#endif // __IBEX_QIBEX_ROUND_ROBIN_H__
