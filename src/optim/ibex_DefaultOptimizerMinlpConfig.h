//============================================================================
//                                  I B E X
// File        : ibex_DefaultOptimizerMinlpConfig.h
...
#ifndef __IBEX_DEFAULT_OPTIMIZER_MINLPCONFIG_H__
#define __IBEX_DEFAULT_OPTIMIZER_MINLPCONFIG_H__
 ...
 *
 * The contractor is HC4 + acid(HC4) + X-Newton and the bisector is MinlpSmearSumRel
 *
 */
class DefaultOptimizerMinlpConfig : public OptimizerConfig, protected Memory {
public:
	 ...
	 */
	DefaultOptimizerMinlpConfig(const System& sys);
	 ...
	 * \deprecated
	 */
	DefaultOptimizerMinlpConfig(	const System& sys, double rel_eps_f, double abs_eps_f,
							double eps_h, bool rigor, bool inHC4, bool kkt,
							int random_seed, double eps_x);

	/**
	 * \brief Delete this.
	 */
	virtual ~DefaultOptimizerMinlpConfig();
...
inline double DefaultOptimizerMinlpConfig::get_eps_h() { return eps_h; }

inline bool DefaultOptimizerMinlpConfig::with_rigor() { return rigor; }

inline bool DefaultOptimizerMinlpConfig::with_inHC4() { return inHC4; }
...
#endif /* __IBEX_DEFAULT_OPTIMIZER_MINLPCONFIG_H__ */
